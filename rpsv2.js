...
function playRound() {
    ...
    return {currentComputerPoints: currentComputerPoints, currentPlayerPoints: currentPlayerPoints, currentResult: currentResult, playerSelection: playerSelection, computerSelection:computerSelection};
}
